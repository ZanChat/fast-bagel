    ...
    if input_string.count(delimiter) == 2:
        ...
        if start_index == -1 or end_index == 0:
            ...
            if give_up_parsing: # if we want to give up parsing
                ...
                print(f"Failed to find the json content in the string {input_string}. Guess a value : {guessed_value}.")
                ...
                print(f"Failed to find the json content in the string {input_string}.")
                return False
