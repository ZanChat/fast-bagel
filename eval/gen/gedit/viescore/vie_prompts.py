...
You will have to give your output in json like following (please output correct and complete json content):
{
"score" : [...]
}"""
...
You will have to give your output in json like following:
||V^=^V||
{
"score" : 
}
