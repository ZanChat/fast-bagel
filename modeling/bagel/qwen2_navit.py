...
class Qwen2MoTDecoderLayer(nn.Module):
    ...
    def forward_inference(
        ...
        if mode == "und":
            ...
            packed_query_sequence_ = torch.zeros_like(packed_query_sequence, device=packed_query_sequence.device)
    ...
    def forward_inference(
        ...
        if self.use_moe:
            if mode == "und":
                ...
                packed_text_indexes = packed_text_indexes.to(packed_query_sequence.device)
                packed_query_sequence_[packed_text_indexes] = self.norm(packed_query_sequence[packed_text_indexes])
                packed_vae_token_indexes = packed_vae_token_indexes.to(packed_query_sequence.device)
