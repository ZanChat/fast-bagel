...
CUDA_VISIBLE_DEVICES=0,1 python3 -u mb_gen_images_gedit-step1x.py --input_dir $ds_path --model_path "$MODEL_PATH"  --output_dir "$OUTPUT_DIR" --seed 1234 --size_level 1024 --version v1.0 --model_name "$MODEL_NAME_STR" --task_list "${@:4}" >> out-eval-$MODEL_NAME_STR 2>&1 &
