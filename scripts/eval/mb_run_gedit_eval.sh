...
# # ---------------------
cd eval/gen/gedit
CUDA_VISIBLE_DEVICES=2,3 python mb_test_gedit_score.py --save_path "$OUTPUT_DIR" --ds_path $ds_path --azure_endpoint "$AZURE_ENDPOINT" --gpt_keys "$AZURE_OPENAI_KEY" --backbone "qwen25vl" --max_workers "$N_GPT_PARALLEL" --groups "mb" &
